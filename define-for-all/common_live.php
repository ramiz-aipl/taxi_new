...
define("USERNAME", "u520948016_horse");
define("PASSWORD", "=k2+YXYOcR");
define("DATABASE", "u520948016_horse");
$BASE_URL = 'https://' . $_SERVER['HTTP_HOST'] . '/';
define("DOCUMENT_ROOT", $_SERVER['DOCUMENT_ROOT'] . '/');


define("WEBSITE_NAME", "The Polo Team - Nasr Polo");
define("WEBSITE_EMAIL", "support@horse.com");
